...
public class TgbDealService extends QtService {
    ...
    public void day7Date() throws Exception {

        List<StockInfoRecord> infos = stockInfoRecordRepository.findAll();
        for (StockInfoRecord stockInfoRecord:infos){
            ...
            stockInfoRecord.setName(stockInfoRecord.getName());
