...
public class StockInfo implements Serializable {
    ...
    public String toString(){
        ...
        sb.append(NumberEnum.StockType.getStockType(getStockType())).append(code).append(name).append("[出现:").append(getShowCount()).append("最高:").append(getFiveHighRate()).append("最低:").append(getFiveLowRate()).
                append("七日:").append(getHotSeven()).append(",连板:").append(getContinuous()).append("]竞价:").append(getTodayOpenRate()).append(",收盘:").append(getTodayCloseRate()).
                append(",明天:").append(getTomorrowOpenRate()).
                append(":").append(getTomorrowCloseRate()).append(getPlateName()).append("<br>");
        return sb.toString();
    }
