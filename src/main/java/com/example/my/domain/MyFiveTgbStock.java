 ...
 */
@Entity(name="my_five_tgb_stock")
public class MyFiveTgbStock implements Comparable<MyFiveTgbStock> {
    @Id
    @GeneratedValue
    private Long id;
    ...
    public MyFiveTgbStock(){
    }
    public MyFiveTgbStock(String code, String name){
        this.code =code;
        this.name = name;
    ...
    @Override
    public int compareTo(MyFiveTgbStock o) {
