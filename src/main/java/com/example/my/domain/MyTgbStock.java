 ...
 */
@Entity(name="my_tgb_stock")
public class MyTgbStock implements Comparable<MyTgbStock> {
    @Id
    @GeneratedValue
    private Long id;
    ...
    public MyTgbStock(String code, String name){
        this.code =code;
        this.name = name;
    ...
    @Override
    public int compareTo(MyTgbStock o) {
