...
import com.example.my.service.DownService;
import com.example.my.service.TemperatureService;
...
public class DownScheduledService {
    ...
    public void close(){
        ...
        try {
            if(chineseWorkDay.isWorkday()){
                temperatureService.temperatureClose();
                downService.close();
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void topen(){
        ...
        try {
            if(chineseWorkDay.isWorkday()){
                temperatureService.temperatureOpen();
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void temperature(){
        ...
        try {
            if(chineseWorkDay.isWorkday()){
                temperatureService.temperatureNormal();
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
